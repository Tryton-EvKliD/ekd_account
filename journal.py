...
class Type(ModelSQL, ModelView):
    'Journal Type'
    _name = 'ekd.account.journal.type'
...
class View(ModelSQL, ModelView):
    'Journal View'
    _name = 'ekd.account.journal.view'
    _description = __doc__
    name = fields.Char('Name', size=None, required=True)
    columns = fields.One2Many('ekd.account.journal.view.column', 'view', 'Columns')
...
class Column(ModelSQL, ModelView):
    'Journal View Column'
    _name = 'ekd.account.journal.view.column'
    _description = __doc__
    name = fields.Char('Name', size=None, required=True)
    field = fields.Many2One('ir.model.field', 'Field', required=True,
            domain=[('model.model', '=', 'ekd.account.move.line')])
    view = fields.Many2One('ekd.account.journal.view', 'View', select=1)
...
class Period(ModelSQL, ModelView):
    'Journal - Period'
    _name = 'ekd.account.journal.period'
    _description = __doc__
...
class ClosePeriod(Wizard):
    'Close Journal - Period'
    _name = 'ekd.account.journal.close_period'
    states = {
        'init': {
            'actions': ['_close'],
            'result': {
...
class ReOpenPeriod(Wizard):
    ...
    _name = 'ekd.account.journal.reopen_period'
    states = {
        'init': {
            'actions': ['_reopen'],
            'result': {
